...
const PAD_DEFS = [
  ...
  { index: 3,  gridClass: 'pad-minus', sound: 'clap',    icon: '👏', color: 'yellow', keyLabel: '−',  keyTrigger: '-',     defaultLabel: 'Clap' },
  ...
  { index: 7,  gridClass: 'pad-plus',  sound: 'riser',   icon: '⬆️', color: 'green',  keyLabel: '+',  keyTrigger: '=',     defaultLabel: 'Riser' },
  ...
  { index: 11, gridClass: 'pad-enter', sound: 'noti',    icon: '🔔', color: 'pink',   keyLabel: '↵',  keyTrigger: 'Enter', defaultLabel: 'Notif' },
  { index: 12, gridClass: 'pad-0',     sound: 'siren',   icon: '🚨', color: 'red',    keyLabel: '0',  keyTrigger: '0',     defaultLabel: 'Siren' },
  { index: 13, gridClass: 'pad-dot',   sound: 'swoosh',  icon: '💨', color: 'green',  keyLabel: '.',  keyTrigger: '.',     defaultLabel: 'Swoosh' },
]
